...
write_csv(OUT_DATA_MUNI, paste0("output/1yr/cohort_assignments_muni_1yr_", COHORT_YEAR, ".csv"))
...
write_csv(OUT_DATA_CCA, paste0("output/1yr/cohort_assignments_cca_1yr_", COHORT_YEAR, ".csv"))


# # Compare scores/cohorts against previous year ----------------------------
#
# prev_year <- COHORT_YEAR - 1
# # prev_muni_csv <- paste0("output/1yr/cohort_assignments_muni_1yr_", prev_year, ".csv")  # Only used for 2022 when no prior 3-year cohorts were available
# # prev_cca_csv <- paste0("output/1yr/cohort_assignments_cca_1yr_", prev_year, ".csv")  # Only used for 2022 when no prior 3-year cohorts were available
