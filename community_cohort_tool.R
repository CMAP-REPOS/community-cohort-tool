...
MUNI_SCORES_3YR_AVG$COHORT_3YR <- cut(as.vector(MUNI_SCORES_3YR_AVG$WEIGHTED_SCORE_3YR), c(-Inf, NEW_COHORTCUTS$MAX_SCORE), NEW_COHORTCUTS$COHORT) # edit here with new cuts
...
CCA_SCORES_3YR_AVG$COHORT_3YR <- cut(as.vector(CCA_SCORES_3YR_AVG$WEIGHTED_SCORE_3YR), c(-Inf, NEW_COHORTCUTS_CCAs$MAX_SCORE), NEW_COHORTCUTS_CCAs$COHORT)
