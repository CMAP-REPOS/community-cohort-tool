...
For each municipal factor included in the `WEIGHTS` table, calculate the median and standard deviation. Use these with specific z-scores to assign municipalities a score from 1-10, such that each group will roughly represent an equal number of municipalities (assuming the factor approximates a normal distribution). 
